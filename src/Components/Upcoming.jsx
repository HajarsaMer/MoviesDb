...
import { getUpcoming, useGeners } from '../useApi'
import { Link } from 'react-router-dom'


export default function Upcoming() {
    let {data,isLoading} = useGeners('upcoming',getUpcoming)
    return (
    <div className="container">
      <h2 className='text-center my-4 text-white fw-bolder'>Upcoming</h2>
